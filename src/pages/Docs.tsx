...
import ShowDocumentDialog from "../components/ShowDocumentDialog.tsx";
...
export default function Docs() {
    ...
    const [updateData] = useRecursiveFetch("application", setFiles);

    const openDisplay = (path: string) => {
        setSelectedDocument(path as string);
    ...
    return (
        <>
            ...
            <ShowDocumentDialog isOpen={documentModal} setIsOpen={setDocumentModal} file={selectedDocument}/>
        </>
    )
}
